...
const ManageUsers = () => {
    ...
    const getAllUserData = () => {
        const url = "https://fiaimining-backend.vercel.app/api/alluserdata";
        axios
            .get(url)
            .then((response) => {
...
// };
    ...
    const Verify = (id) => { 
            const url = `https://fiaimining-backend.vercel.app/api/UserVerify/${id}`;
            axios.patch(url)
                .then((response) => {
    ...
    return (
        <>
            <div className="w-full h-max px-6 py-10 flex flex-col gap-2 phone:gap-8 bg-[#f9fbfd] text-[rgb(87,89,98)]">
                <p className="text-[27px] font-semibold">Swifteatrn Prime users list</p>
